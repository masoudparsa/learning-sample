...
class GetxSampleScreen extends StatefulWidget {
  const GetxSampleScreen({super.key});

  @override
  State<GetxSampleScreen> createState() => _GetxSampleScreenState();
}

class _GetxSampleScreenState extends State<GetxSampleScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Directionality(
        ...
        child: GetX<EmployeeGetXConroller>(
          initState: (state) {
            Get.find<EmployeeGetXConroller>().getEmployees();
          },
          builder: (controller) {
            return (controller.state.value == MyState.loading)
      ...
      floatingActionButton: FloatingActionButton(
        child: Get.find<EmployeeGetXConroller>().state == MyState.adding
